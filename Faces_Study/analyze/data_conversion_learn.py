...
data_dir = 'learning-task/data/'
# copy files from original directory? Note: must specify directies below
copy_orig_files = False
# overwrite files (via copying and conversion)? Yes=True No=False
overwrite   = False

# copy data files over
if copy_orig_files:
    data_dir = os.path.join(os.getcwd(),data_dir)
    orig_data_dir = '/Users/miriam/GoogleDrive/GraduateWork/GitHub/network-learning2/learning-task/data/'
