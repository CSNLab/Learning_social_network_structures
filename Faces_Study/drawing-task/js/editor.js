...
$(function() {
    ...
    sid = parseInt(sid);
    var nodeName = 'person';
    $('#instr').html('Click "Add Connection" to add connections between people' +
    ...
    // initialize firebase
    var config = {
        apiKey: "AIzaSyDQXY5ie3_6bu4FfNbyIaL0crtZpUpebxU",
        authDomain: "network-editor-v2.firebaseapp.com",
        databaseURL: "https://network-editor-v2.firebaseio.com",
        projectId: "network-editor-v2",
        storageBucket: "network-editor-v2.appspot.com",
        messagingSenderId: "1065635131620",
        appId: "1:1065635131620:web:d95bcf780ba13fc329bcf1"
    };
    ...
    $('#submit').click(function() {
        ...
        nodes.forEach(function(elem, index) {
            ...
            console.log(elem);
            elem.image = subject_imgs[sid][sectionId][elem.id][0];
            elem.label = subject_imgs[sid][sectionId][elem.id][1];
        });
